...
1. Nota: defina un nombre para su grupo, definalo claramente en su **reporte** y use este nombre como parte inicial de **todos los recursos que cree**
...
SELECT *
FROM "covid" AS cvd
JOIN "paises" AS ps ON cvd.country=ps.country
LIMIT 5;
```
